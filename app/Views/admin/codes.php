...
<body>
  <div class="page-wrap">
    ...
    <section class="section">
      <h2 class="section-title">Gestion des codes</h2>
      <p class="section-sub">Generation et suivi des codes prepayes (placeholder).</p>
      <div class="card">
        <h4>Codes prepayes</h4>
        <small>Cette page sera reliee a la table Code.</small>
      </div>
    </section>
  </div>
</body>
