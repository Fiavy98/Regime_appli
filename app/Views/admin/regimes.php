...
<body>
  <div class="page-wrap">
    ...
    <section class="section">
      ...
      <p class="section-sub">CRUD programmes, composition et aliments (placeholder).</p>
      <div class="card">
        <h4>Regimes</h4>
        <small>Cette page sera reliee aux tables programmeRegime et programmeAliment.</small>
      </div>
    </section>
  </div>
</body>
